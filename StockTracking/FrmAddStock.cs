...
namespace StockTracking
{
    public partial class FrmAddStock : Form
    {
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtCategoryName.Text = detail.ProductName;
            detail.Price = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[3].Value);
            txtPrice.Text = detail.Price.ToString();
            detail.StockAmout = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[2].Value);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (txtCategoryName.Text.Trim() == "")
                ...
                MessageBox.Show("Plerase give a stock amount");
            else
            {
                int sumstock = detail.StockAmout;
                sumstock = Convert.ToInt32(txtStock.Text);
                detail.StockAmout= sumstock;
