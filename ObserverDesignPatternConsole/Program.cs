...
{      
    ...
    abstract class Product
    {
        ...
        public void Deattech(IMarket market)
        {
    ...
    class Market : IMarket
    {
        ...
        {
            Console.WriteLine("Notify: In "+ Name + "the price of "+ product.GetType().Name+ " was changed with "+ product.priceperpound);
        }
    }
     class Program
    {   
        static void Main(string[] args)
        {
            ...
            var qlqrcvoisa = new Market("Market1", 1);
            chocolate.Attach(qlqrcvoisa);
            ...
            chocolate.Deattech(qlqrcvoisa);
            chocolate.priceperpound = 12;
            Console.ReadKey();
        }
    }
}
